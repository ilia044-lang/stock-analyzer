...
ECONOMIC_CALENDAR = [
    ...
    # ── NFP — תעסוקה ──
    {"date": "2025-04-04", "event": "NFP — תעסוקה מרץ 💼",                           "type": "nfp"},
    {"date": "2025-05-02", "event": "NFP — תעסוקה אפריל 💼",                         "type": "nfp"},
    {"date": "2025-06-06", "event": "NFP — תעסוקה מאי 💼",                           "type": "nfp"},
    {"date": "2025-07-03", "event": "NFP — תעסוקה יוני 💼",                          "type": "nfp"},
    {"date": "2025-08-01", "event": "NFP — תעסוקה יולי 💼",                          "type": "nfp"},
    {"date": "2025-09-05", "event": "NFP — תעסוקה אוגוסט 💼",                        "type": "nfp"},
    {"date": "2025-10-03", "event": "NFP — תעסוקה ספטמבר 💼",                       "type": "nfp"},
    {"date": "2025-11-07", "event": "NFP — תעסוקה אוקטובר 💼",                      "type": "nfp"},
    {"date": "2025-12-05", "event": "NFP — תעסוקה נובמבר 💼",                       "type": "nfp"},
    {"date": "2026-01-09", "event": "NFP — תעסוקה דצמבר 💼",                        "type": "nfp"},
    {"date": "2026-02-06", "event": "NFP — תעסוקה ינואר 💼",                        "type": "nfp"},
    {"date": "2026-03-06", "event": "NFP — תעסוקה פברואר 💼",                       "type": "nfp"},
    {"date": "2026-04-03", "event": "NFP — תעסוקה מרץ 💼",                          "type": "nfp"},
    {"date": "2026-05-01", "event": "NFP — תעסוקה אפריל 💼",                        "type": "nfp"},
    {"date": "2026-06-05", "event": "NFP — תעסוקה מאי 💼",                          "type": "nfp"},
    {"date": "2026-07-02", "event": "NFP — תעסוקה יוני 💼",                         "type": "nfp"},
    # ── CPI — מחירי צרכן ──
    {"date": "2025-04-10", "event": "CPI — מחירי צרכן מרץ 📊",                      "type": "cpi"},
    {"date": "2025-05-13", "event": "CPI — מחירי צרכן אפריל 📊",                    "type": "cpi"},
    {"date": "2025-06-11", "event": "CPI — מחירי צרכן מאי 📊",                      "type": "cpi"},
    {"date": "2025-07-15", "event": "CPI — מחירי צרכן יוני 📊",                     "type": "cpi"},
    {"date": "2025-08-12", "event": "CPI — מחירי צרכן יולי 📊",                     "type": "cpi"},
    {"date": "2025-09-10", "event": "CPI — מחירי צרכן אוגוסט 📊",                   "type": "cpi"},
    {"date": "2025-10-14", "event": "CPI — מחירי צרכן ספטמבר 📊",                  "type": "cpi"},
    {"date": "2025-11-13", "event": "CPI — מחירי צרכן אוקטובר 📊",                 "type": "cpi"},
    {"date": "2025-12-10", "event": "CPI — מחירי צרכן נובמבר 📊",                  "type": "cpi"},
    {"date": "2026-01-14", "event": "CPI — מחירי צרכן דצמבר 📊",                   "type": "cpi"},
    {"date": "2026-02-11", "event": "CPI — מחירי צרכן ינואר 📊",                   "type": "cpi"},
    {"date": "2026-03-11", "event": "CPI — מחירי צרכן פברואר 📊",                  "type": "cpi"},
    {"date": "2026-04-14", "event": "CPI — מחירי צרכן מרץ 📊",                     "type": "cpi"},
    {"date": "2026-05-13", "event": "CPI — מחירי צרכן אפריל 📊",                   "type": "cpi"},
    {"date": "2026-06-11", "event": "CPI — מחירי צרכן מאי 📊",                     "type": "cpi"},
    {"date": "2026-07-14", "event": "CPI — מחירי צרכן יוני 📊",                    "type": "cpi"},
    # ── PPI — מחירי יצרן ──
    {"date": "2025-04-11", "event": "PPI — מחירי יצרן מרץ 📦",                     "type": "ppi"},
    {"date": "2025-05-14", "event": "PPI — מחירי יצרן אפריל 📦",                   "type": "ppi"},
    {"date": "2025-06-12", "event": "PPI — מחירי יצרן מאי 📦",                     "type": "ppi"},
    {"date": "2025-07-16", "event": "PPI — מחירי יצרן יוני 📦",                    "type": "ppi"},
    {"date": "2025-08-13", "event": "PPI — מחירי יצרן יולי 📦",                    "type": "ppi"},
    {"date": "2025-09-11", "event": "PPI — מחירי יצרן אוגוסט 📦",                  "type": "ppi"},
    {"date": "2025-10-15", "event": "PPI — מחירי יצרן ספטמבר 📦",                 "type": "ppi"},
    {"date": "2025-11-14", "event": "PPI — מחירי יצרן אוקטובר 📦",                "type": "ppi"},
    {"date": "2025-12-11", "event": "PPI — מחירי יצרן נובמבר 📦",                 "type": "ppi"},
    {"date": "2026-01-15", "event": "PPI — מחירי יצרן דצמבר 📦",                  "type": "ppi"},
    {"date": "2026-02-12", "event": "PPI — מחירי יצרן ינואר 📦",                  "type": "ppi"},
    {"date": "2026-03-12", "event": "PPI — מחירי יצרן פברואר 📦",                 "type": "ppi"},
    {"date": "2026-04-14", "event": "PPI — מחירי יצרן מרץ 📦",                    "type": "ppi"},
    {"date": "2026-05-14", "event": "PPI — מחירי יצרן אפריל 📦",                  "type": "ppi"},
    {"date": "2026-06-12", "event": "PPI — מחירי יצרן מאי 📦",                    "type": "ppi"},
    # ── GDP ──
    {"date": "2025-04-30", "event": "GDP Q1 2025 — אמדן ראשון 📈",                 "type": "gdp"},
    {"date": "2025-07-30", "event": "GDP Q2 2025 — אמדן ראשון 📈",                 "type": "gdp"},
    {"date": "2025-10-29", "event": "GDP Q3 2025 — אמדן ראשון 📈",                 "type": "gdp"},
    {"date": "2026-01-28", "event": "GDP Q4 2025 — אמדן ראשון 📈",                 "type": "gdp"},
    {"date": "2026-04-29", "event": "GDP Q1 2026 — אמדן ראשון 📈",                 "type": "gdp"},
    {"date": "2026-07-29", "event": "GDP Q2 2026 — אמדן ראשון 📈",                 "type": "gdp"},
    # ── PCE — אינפלציית הצריכה ──
    {"date": "2025-04-30", "event": "PCE — אינפלציית הצריכה מרץ 📊",               "type": "pce"},
    {"date": "2025-05-30", "event": "PCE — אינפלציית הצריכה אפריל 📊",             "type": "pce"},
    {"date": "2025-06-27", "event": "PCE — אינפלציית הצריכה מאי 📊",               "type": "pce"},
    {"date": "2025-07-31", "event": "PCE — אינפלציית הצריכה יוני 📊",              "type": "pce"},
    {"date": "2025-08-29", "event": "PCE — אינפלציית הצריכה יולי 📊",              "type": "pce"},
    {"date": "2025-09-26", "event": "PCE — אינפלציית הצריכה אוגוסט 📊",            "type": "pce"},
    {"date": "2025-10-31", "event": "PCE — אינפלציית הצריכה ספטמבר 📊",           "type": "pce"},
    {"date": "2025-11-26", "event": "PCE — אינפלציית הצריכה אוקטובר 📊",          "type": "pce"},
    {"date": "2025-12-19", "event": "PCE — אינפלציית הצריכה נובמבר 📊",           "type": "pce"},
    {"date": "2026-01-30", "event": "PCE — אינפלציית הצריכה דצמבר 📊",            "type": "pce"},
    {"date": "2026-02-27", "event": "PCE — אינפלציית הצריכה ינואר 📊",            "type": "pce"},
    {"date": "2026-03-27", "event": "PCE — אינפלציית הצריכה פברואר 📊",           "type": "pce"},
    {"date": "2026-04-30", "event": "PCE — אינפלציית הצריכה מרץ 📊",              "type": "pce"},
    {"date": "2026-05-29", "event": "PCE — אינפלציית הצריכה אפריל 📊",            "type": "pce"},
    {"date": "2026-06-26", "event": "PCE — אינפלציית הצריכה מאי 📊",              "type": "pce"},
    # ── מכירות קמעונאות ──
    {"date": "2025-04-16", "event": "מכירות קמעונאות מרץ 🛒",                      "type": "retail"},
    {"date": "2025-05-15", "event": "מכירות קמעונאות אפריל 🛒",                    "type": "retail"},
    {"date": "2025-06-17", "event": "מכירות קמעונאות מאי 🛒",                      "type": "retail"},
    {"date": "2025-07-16", "event": "מכירות קמעונאות יוני 🛒",                     "type": "retail"},
    {"date": "2025-08-15", "event": "מכירות קמעונאות יולי 🛒",                     "type": "retail"},
    {"date": "2025-09-16", "event": "מכירות קמעונאות אוגוסט 🛒",                   "type": "retail"},
    {"date": "2025-10-16", "event": "מכירות קמעונאות ספטמבר 🛒",                  "type": "retail"},
    {"date": "2025-11-14", "event": "מכירות קמעונאות אוקטובר 🛒",                 "type": "retail"},
    {"date": "2025-12-16", "event": "מכירות קמעונאות נובמבר 🛒",                  "type": "retail"},
    {"date": "2026-01-15", "event": "מכירות קמעונאות דצמבר 🛒",                   "type": "retail"},
    {"date": "2026-02-13", "event": "מכירות קמעונאות ינואר 🛒",                   "type": "retail"},
    {"date": "2026-03-13", "event": "מכירות קמעונאות פברואר 🛒",                  "type": "retail"},
    {"date": "2026-04-15", "event": "מכירות קמעונאות מרץ 🛒",                     "type": "retail"},
    {"date": "2026-05-15", "event": "מכירות קמעונאות אפריל 🛒",                   "type": "retail"},
    {"date": "2026-06-16", "event": "מכירות קמעונאות מאי 🛒",                     "type": "retail"},
    # ── עונת דוחות רבעוניים ──
    ...
    {"date": "2026-04-09", "event": "תחילת עונת דוחות Q1 2026 📋",                   "type": "earnings"},
    {"date": "2026-07-10", "event": "תחילת עונת דוחות Q2 2026 📋",                   "type": "earnings"},
]
